    ...
    <div class="container">
        ...
        <div class="panel-body mt-4" id="toro-area">
            <form id="toro-form" method="POST"
                action="{{ ($data['actions'] == 'store') ? route('order.store') : route('order.update', base64_encode($data['beli_order']->id)) }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="tanggal" name="tanggal"
                            placeholder="Masukkan Tanggal" value="{{ $data['beli_order']->tanggal }}" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="tanggal_dibutuhkan" name="tanggal_dibutuhkan"
                            placeholder="Masukkan Tanggal Dibutuhkan" value="{{ $data['beli_order']->tanggal_dibutuhkan }}"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="no_faktur" name="no_faktur"
                            placeholder="Masukkan No Faktur" value="{{ $data['beli_order']->no_faktur }}" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="id_m_vendor" name="id_m_vendor"
                            placeholder="Masukkan Nama Vendor" value="{{ $data['beli_order']->id_m_vendor }}" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="id_user_verifikasi" class="col-sm-2 col-form-label">ID User Verifikasi</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="id_user_verifikasi" name="id_user_verifikasi"
                            placeholder="Masukkan User Verifikasi" value="{{ $data['beli_order']->id_user_verifikasi }}"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="ppn_percent" name="ppn_percent"
                            placeholder="Masukkan PPN" value="{{ $data['beli_order']->ppn_percent }}" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pp_nominal" name="pp_nominal"
                            placeholder="Masukkan PPN Nominal" value="{{ $data['beli_order']->pp_nominal }}" required>
                    </div>
                </div>
                <div class="form-group row">
