        ...
        <div class="panel-body mt-4" id="toro-area">
            <form id="toro-form" method="POST"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="js-example-placeholder-multiple form-control" name="id_access_group" id="id_access_group">
                            @for ($i = 0; $i < count($data['access_group']); $i++) <option value="{{ $data['access_group'][$i]->id }}">
